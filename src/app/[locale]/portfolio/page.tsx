...
export default function PortfolioPage({ params }: { params: { locale: Locale } }) {
  const t = getDictionary(params.locale).portfolio;

  return (
    <main className="max-w-2xl mx-auto py-12 sm:py-16 px-6 flex flex-col min-h-[100dvh] space-y-10">
      <section id="hero">
          ...
          <BlurFade delay={BLUR_FADE_DELAY * 16}>
            <div className="space-y-3">
              ...
              <p className="mx-auto max-w-[600px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                {params.locale === "es" ? "¿Quieres hablar? Escríbeme" : "Want to chat? Just shoot me a dm"}{" "}
                <Link href={DATA.contact.social.ig.url} className="text-blue-500 hover:underline">
                  {t.contact_link}
                </Link>{" "}
                {t.contact_reply}
              </p>
